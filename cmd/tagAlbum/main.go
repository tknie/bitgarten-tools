...
func init() {
	services.ServerMessage("Start Tag Album application %s (build at %s)", bitgartentools.BuildVersion, bitgartentools.BuildDate)

	err := log.InitZapLogWithFilename("tagAlbum.log")
	if err != nil {
