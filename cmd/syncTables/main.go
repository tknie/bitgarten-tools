...
func init() {
	services.ServerMessage("Start Sync Tables application %s (build at %s)", bitgartentools.BuildVersion, bitgartentools.BuildDate)

	err := log.InitZapLogWithFilename("syncTables.log")
	if err != nil {
